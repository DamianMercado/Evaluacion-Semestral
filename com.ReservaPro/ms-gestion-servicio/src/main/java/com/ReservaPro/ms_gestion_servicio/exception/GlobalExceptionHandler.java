...
public class GlobalExceptionHandler {
    ...
    @ExceptionHandler(GestionServicioNotFoundException.class)
    public ResponseEntity<Map<String, Object>> handleGestionServicioNotFound(GestionServicioNotFoundException ex) {
