...
import com.ReservaPro.ms_pago.dto.response.PruebaResponse;
...
public class PagoController {
    ...
    public  ResponseEntity<PruebaResponse> verPrueba (@PathVariable Long id){
        return  ResponseEntity.ok(pagoService.verPrueba(id));
    }
}
