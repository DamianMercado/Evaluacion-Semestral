...
public class ReservaService {
    ...
    public ReservaResponse crear(ReservaRequest request) {
        ...
        log.info(
                "Creando nueva reserva para usuario: {}",
        ...
        log.info(
                "Reserva creada correctamente con ID: {} - Estado: {}",
                guardada.getId(),
    ...
    @Transactional
    public ReservaResponse confirmarPago(
            Long id,
            ReservaPagoRequest request) {

        log.info(
                "Confirmando pago para reserva ID: {} con pago ID: {}",
                id,
                request.getIdPago()
        );
        ...
        log.info(
                "Pago confirmado para reserva ID: {} - Estado: {}",
                id,
    ...
    public ReservaResponse cancelarReserva(Long id) {
        ...
        if (!reserva.getEstadoReserva()
                .puedeTransicionarA(EstadoReserva.CANCELADA)) {
    ...
    @Transactional(readOnly = true)
    public List<ReservaResponse> obtenerPorUsuario(
            Long idUsuario) {
    ...
    @Transactional(readOnly = true)
    public List<ReservaResponse> obtenerPorEstado(
    ...
    @Transactional(readOnly = true)
    public List<ReservaResponse> obtenerPorUsuarioYEstado(
            Long idUsuario,
            EstadoReserva estado) {

        log.info(
                "Buscando reservas del usuario {} con estado {}",
                idUsuario,
                estado.getValor()
        );

        return reservaMapper.toResponseList(
                reservaRepository.findByIdUsuarioAndEstadoReserva(
                        idUsuario,
                        estado
                )
        );
    ...
    public ReservaCompletaResponse obtenerReservaCompleta(Long id) {
        ...
        log.info(
                "Obteniendo reserva completa con ID: {}",
                id
        );
        ...
        ReservaCompletaResponse response =
                new ReservaCompletaResponse();
        ...
        try {
            ...
            log.warn(
                    "No se pudo obtener usuario para reserva {}: {}",
                    id,
                    e.getMessage()
            );
        }
        ...
        try {
            response.setServicio(
                    gestionServicioClient.obtenerServicioPorId(
                            reserva.getIdGestionServicio()
                    )
            );
        } catch (Exception e) {
            log.warn(
                    "No se pudo obtener servicio para reserva {}: {}",
                    id,
                    e.getMessage()
            );
        }
        ...
        if (reserva.getIdPago() != null) {
            try {
                response.setPago(
                        pagoClient.obtenerPagoPorId(
                                reserva.getIdPago()
                        )
                );
            } catch (Exception e) {
                log.warn(
                        "No se pudo obtener pago para reserva {}: {}",
                        id,
                        e.getMessage()
                );
            }
        ...
        if (reserva.getIdCalificacion() != null) {
            try {
                response.setCalificacion(
                        calificacionClient.obtenerCalificacionPorId(
                                reserva.getIdCalificacion()
                        )
                );
            } catch (Exception e) {
                log.warn(
                        "No se pudo obtener calificación para reserva {}: {}",
                        id,
                        e.getMessage()
                );
            }
        ...
        try {
            response.setCancelacion(
                    cancelacionClient.obtenerCancelacionPorId(id)
            );
        } catch (Exception e) {
            log.warn(
                    "No se pudo obtener la cancelación para reserva {}: {}",
                    id,
                    e.getMessage()
            );
        }
    ...
    private void validarServicio(Long idServicio) {
        ...
        try {
            ...
            throw new IllegalArgumentException(
                    "Servicio no encontrado con ID: " + idServicio
            );
        }
    }
